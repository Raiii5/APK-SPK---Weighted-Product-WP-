            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  <h4 class="card-title">Matriks Keputusan (Data Kinerja)</h4>
                </div>
                <div class="card-content">
                  <div class="card-body">
                   <p class="card-text">
    Tabel di bawah ini menampilkan data kinerja atau <em>rating</em> asli dari setiap alternatif (karyawan). Data ini akan langsung diproses ke dalam perhitungan metode <em>Weighted Product</em> (WP) tanpa memerlukan normalisasi matriks.</p>
                  </div>
